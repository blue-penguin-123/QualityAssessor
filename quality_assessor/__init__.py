...
This package provides three standardized quality assessment methodologies:
...
This is a standalone package that uses dependency injection.
All dependencies (models, prompts, LLM providers) are passed to the assessors.
"""
